...
async function main() {
            ...
            data: {
                ...
                donorProfile: {
                    create: {
                        ...
                        donorType: DonorType[donor.donorType],
                        totalDonation: 0,
                        points: 0,
                    },
                },
    ...
    for (const donor of createdDonors.slice(0, 3)) {
        ...
        try {
            ...
            console.log(`   ⚠️  Could not reserve for ${donor.displayName}: ${e.message}`);
        }
    }
    // ============================================
            ...
            data: {
                ...
                beneficiaryProfile: {
                    create: {
                        ...
                        gender: beneficiary.gender ? Gender[beneficiary.gender] : undefined,
                        ...
                        householdPosition: HouseholdPosition[beneficiary.householdPosition],
                        mainEmploymentStatus: beneficiary.mainEmploymentStatus ? MainEmploymentStatus[beneficiary.mainEmploymentStatus] : undefined,
                        incomeSources: beneficiary.incomeSources.map((src) => IncomeSource[src]),
